...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSPatientENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSPatientENDCLASS_t qt_meta_stringdata_CLASSPatientENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7)   // "Patient"
    },
    "Patient"
};
